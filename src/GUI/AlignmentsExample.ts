...
export default class BasicScene {
  ...
  CreateGUI() {
    ...
    advancedDynamicTexture.addControl(rect2);
    rect2.horizontalAlignment = Control.HORIZONTAL_ALIGNMENT_RIGHT;

    // 上对齐
    const rect3 = this.CreateRectangle();
    advancedDynamicTexture.addControl(rect3);
    rect3.verticalAlignment = Control.VERTICAL_ALIGNMENT_TOP;

    // 下对齐
    const rect4 = this.CreateRectangle();
    advancedDynamicTexture.addControl(rect4);
    rect4.verticalAlignment = Control.VERTICAL_ALIGNMENT_BOTTOM;
  }
